...
def create_hf_bert_classification(
    ...
    if num_labels == 1:
        ...
        metrics = [
            MultilabelF1Score(num_labels=num_labels, average='micro', threshold=0.7),
            F1Score(task='multilabel', num_classes=num_labels, num_labels=num_labels, average='micro', threshold=0.7),
