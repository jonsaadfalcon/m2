...
from src.longcontext.create_dataset import create_long_context_dataset
...
def main(cfg: DictConfig,
    ...
    trainer = Trainer(
        ...
        loggers=loggers,
        #callbacks=[EarlyStopper('MulticlassAccuracy', 'eval', patience=10)],
        #callbacks=[EarlyStopper('MultilabelF1Score', 'eval', patience=5)],
        #callbacks=[EarlyStopper('AUROC', 'eval', patience=5)],
        callbacks=callbacks,
